...
public abstract class BaseClass
{
    ...
    abstract public void generateSource(String tabString);
...
//        sourceBuf.append (generateClassComments ());
    ...
    protected void printLogger (String tabString)
    {
        sourceBuf.append (tabString + "final static Logger logger = LoggerFactory.getLogger (" + this.name + this.classSuffix + ".class);\n\n");
    }
    ...
    protected void printCloseBrace (int indentLevel, int newLines, String tabString)
    {
        for (int i = 0; i < indentLevel; i++)
        {
            sourceBuf.append (tabString + "");
    ...
    {
        // no args constructor
        sourceBuf.append (tabString + "public " + WordUtils.capitalize (CodeGenUtil.normalize (name)) + this.classSuffix + " ()\n");
        this.printOpenBrace (1, 2, tabString);
        this.printCloseBrace (1, 2, tabString);
    }

    protected void printToString (String tabString)
    {
        //override toString()
        sourceBuf.append (tabString + "@Override\n" + tabString + "public String toString () \n");
        this.printOpenBrace (1, 1, tabString);
        sourceBuf.append (tabString + tabString + "return ToStringBuilder.reflectionToString (this); \n");
        this.printCloseBrace (1, 2, tabString);
    }
    ...
    public void createFile(String tabString) throws Exception
    {
    ...
    protected void printUserSourceCode (String tabString)
    {
...
//            this.sourceBuf.append (BaseClass.generateUserSourceCodeTags (tabString));
        ...
        {
            this.sourceBuf.append (tabString + "" + userSource);
        }
